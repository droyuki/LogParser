...
public class DNS {
    ...
    private static Map<String, String> parseBody(Map<String, String> bodyMap, String body) {
        ...
        for (String msg : msgSetcion) {
            ...
            System.out.println("\"Msg_" + key + "\":\"" + value + "\",");
        }

        //parse answer section (only DATA field)
        for (String ans : ansSection) {
            int dataCounter = 1;
            System.out.println("Ans Section:" + ans);
            if (ans.contains("empty")) {
                bodyMap.put("Ans", "empty");
                ...
                bodyMap.put("DATA" + dataCounter, data);
                System.out.println("\"Ans_" + "DATA" + dataCounter + "\":\"" + data + "\",");
                dataCounter++;
                continue;
            }
        }
